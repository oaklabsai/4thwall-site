...
Languages: calls and texts are answered and qualified in English or Spanish — the customer is answered in the language they wrote in (a Spanish version of the live demo exists at /missed-calls-es). Asked about any OTHER language: don't guess — honest deflection to the fit call.
